...
public interface AccountsApi {
    ...
    /**
     * PUT /accounts : Update Existing User Account
     * Update existing user account information such as firstName, lastName and Email
     *
     * @param accountId The id of the account to Update (required)
     * @param createAccountDto Modified user account details (required)
    ...
    @Operation(
        ...
        description = "Update existing user account information such as firstName, lastName and Email",
        tags = { "Accounts" },
        responses = {
            @ApiResponse(responseCode = "201", description = "User account updated", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AccountDto.class))
            }),
            @ApiResponse(responseCode = "400", description = "Bad request", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class))
    ...
    default ResponseEntity<AccountDto> updateUserAccount(
        @NotNull @Parameter(name = "accountId", description = "The id of the account to Update", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "accountId", required = true) UUID accountId,
        @Parameter(name = "CreateAccountDto", description = "Modified user account details", required = true) @Valid @RequestBody CreateAccountDto createAccountDto
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
